...
describe('Funcion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'funcion', component: FuncionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.funcions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
