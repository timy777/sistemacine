...
export class FuncionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.funcionService
      ...
      .subscribe({
        next: (res: HttpResponse<IFuncion[]>) => {
  ...
  delete(funcion: IFuncion): void {
    const modalRef = this.modalService.open(FuncionDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IFuncion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
