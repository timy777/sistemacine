...
describe('Genero Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'genero', component: GeneroComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.generos?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
