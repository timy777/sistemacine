...
describe('Pelicula Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'pelicula', component: PeliculaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.peliculas?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
