...
export class DetalleVentaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.detalleVentaService
      ...
      .subscribe({
        next: (res: HttpResponse<IDetalleVenta[]>) => {
  ...
  delete(detalleVenta: IDetalleVenta): void {
    const modalRef = this.modalService.open(DetalleVentaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.detalleVenta = detalleVenta;
  ...
  protected onSuccess(data: IDetalleVenta[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
